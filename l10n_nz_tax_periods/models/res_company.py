...
class ResCompany(models.Model):
    ...
    def _get_tax_closing_period_boundaries(self, date, report):
        ...
        Because in NZ the tax year USUALLY starts on 1st April, but for GST reporting can
        actually be any 1st of month, we need to be able to override the end date of the
        tax period. For alternate periods you will need to override this method and set a
        tax_period_start context key (must be Date).
        """
        self.ensure_one()
